...
close all
%% Symbol definition
syms aI bI cI aJ bJ cJ aK bK cK s z xI yI xJ yJ xK yK E1 nu t real
...
NI(s,z) = (aI + bI*s +cI*z)/(2*A)
NJ(s,z) = (aJ + bJ*s +cJ*z)/(2*A)
NK(s,z) = (aK + bK*s +cK*z)/(2*A)
...
NI(s,z) = (aI + bI*s +cI*z)/(2*A)  %z è y e s è x
NJ(s,z) = (aJ + bJ*s +cJ*z)/(2*A)
NK(s,z) = (aK + bK*s +cK*z)/(2*A)
