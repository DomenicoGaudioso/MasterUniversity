...
t=1;                               % [m] Thickness
%% data structure
nnd =81;                 % Number of nodes in system
...
I=[ 1 3 5 7 21 23 25 27 19 21 23 25 39 41 43 45 37 39 41 43 56 58  60 54 56 58 69 71 67 69 78 76]';
J=[ 19 21 23 25 3 5 7 9 37 39 41 43 21 23 25 27 54 56 58 60 39 41 43 67 69 71 56 58 76 78 69 81]';
K=[ 3 5 7 9 19 21 23 25 21 23 25 27 37 39 41 43 39 41 43 45 54 56 58 56 58 60 67 69 69 71 76 78]';
L=[ 10 12 14 16 12 14 16 18 28 30 32 34 30  32 34 36 46 48 50 52 48 50 52 61 63 65 63 65 72 74 74 79]';
M=[ 11 13 15 17 11 13 15 17 29 31 33 35 29 31 33 35 47 49 51 53 47 49 51 62 64 66 62 64 73 75 73 80]';
N=[ 2 4 6 8 20 22 24 26 20 22 24 26 38 40 42 44 38 40 42 44 55 57 59 55 57 59 68 70 68 70 77 77]';
...
for e=[1 10 19 28 37 46 54 61 67 72 76 79 81] % nodi vincolati
    Kstar(e*ndof-1,:)=0;
    Kstar(:,e*ndof-1)=0;
...
[C,h] = contourf(X1,Y1,sigma_X,'EdgeColor','none','LineWidth',0.1);
...
[C,h] = contourf(X1,Y1,sigma_Y,'EdgeColor','none','LineWidth',0.1);
clabel(C,h,'FontSize',5,'Color','k');
...
[C,h] = contourf(X1,Y1,tau_XY,'EdgeColor','none','LineWidth',0.1);
clabel(C,h,'FontSize',5,'Color','k');
...
[C,h] = contourf(X1,Y1,sigma_Z,'EdgeColor','none','LineWidth',0.1);
clabel(C,h,'FontSize',5,'Color','k');
...
[C,h] = contourf(X1,Y1,sigma_VM1,'EdgeColor','none','LineWidth',0.1);
clabel(C,h,'FontSize',5,'Color','k');
