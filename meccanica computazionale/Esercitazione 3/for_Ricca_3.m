...
title(['\fontname{Courier}\fontsize{15} Stresses in the x direction '],'color','K');
axis([-0.1 1 -0.06  5.8]);
axis equal
axis off
hold on
...
hold on
c=colorbar
colormap  %fa tipo delle curve di livello
title(['\fontname{Courier}\fontsize{15}Stresses in the y direction '],'color','K');
axis([-0.1 1 -0.06  5.8]);
axis equal
axis off
hold on
...
c=colorbar
colormap
title(['\fontname{Courier}\fontsize{15}Stresses in the xy direction '],'color','K');
axis([-0.1 1 -0.06  5.8]);
axis equal
axis off
hold on
...
c=colorbar
colormap
title(['\fontname{Courier}\fontsize{15}Stresses in the z direction'],'color','K');
axis([-0.1 1 -0.06  5.8]);
axis equal
axis off
hold on