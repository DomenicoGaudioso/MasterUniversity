...
s2=Y
s3=X_neg
## CALCOLO FUNZIONE D'INGOBAMENTO
psi1=-s1*H/2
psi2=0
psi3=-s1*H/2
...
#ali sup
plt.subplot(1,3,(1))
plt.suptitle('$\Gamma_{T_2}$ sezione ad H [$N/mm^2$]')
plt.contour(X_pos, Z, tauT2_1sx, delta)
plt.contour(X_neg, Z, tauT2_1dx, delta)
A1=plt.contourf(X_pos, Z, tauT2_1sx, delta,cmap='jet')
A2=plt.contourf(X_neg, Z, tauT2_1dx, delta,cmap='jet')
